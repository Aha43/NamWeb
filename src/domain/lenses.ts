...
export function unusedTags(doc: WorkspaceDocument): string[] {
  ...
  // A tag that backs a saved view or mission control is in use too — deleting it would rewrite or
  // orphan that saved surface, so it must never read as "safe to delete" (#939 review, P2).
