...
export const RESOURCE_TYPE_DEFS: Record<ResourceType, ResourceTypeDef> = {
  URI: { type: 'URI', icon: Link2, labelKey: 'resourceType.URI', hasNameField: true, valueKind: 'text' },
  ...
  COUNT: { type: 'COUNT', icon: Hash, labelKey: 'resourceType.COUNT', hasNameField: true, valueKind: 'countTarget' },
};
